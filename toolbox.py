...
def showLatent(model: nn.Module, X_train: Tensor, X_test: Tensor, batch_size: int, y_train: Tensor = None,
			   y_test: Tensor = None, device: Device = None, s: int = 2, figsize: Tuple[int, int] = (20, 14)
...
def showInterpolation(model: nn.Module, output_shape: np.array, device: Device, n: int,
